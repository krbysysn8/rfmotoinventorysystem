...
<!-- PRODUCT OVERVIEW -->
      <div class="page active" id="page-products">
        <div class="section-header">
          ...
          <div class="section-actions admin-only"><button class="btn btn-primary btn-sm" onclick="openAddProduct()"><i class="fa-solid fa-plus"></i> Add Product</button></div>
        </div>
...
async function doLogout() {
  ...
  sessionStorage.removeItem('rfmoto_token'); localStorage.removeItem('rfmoto_token'); sessionStorage.removeItem('rfmoto_user'); localStorage.removeItem('rfmoto_user');
