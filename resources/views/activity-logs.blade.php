      ...
      <div class="table-card">
        <div class="tbl-scroll">
          <table class="tbl">
            ...
            <tbody id="logsTbl"><tr><td colspan="5"><div class="empty-state"><i class="fa-solid fa-spinner fa-spin"></i><p>Loading logs...</p></div></td></tr></tbody>
          </table>
        </div>
      </div>
    </div>
...
function renderLogs(rows) {
    el('logCount').textContent = `${rows.length} log${rows.length !== 1 ? 's' : ''}`;
